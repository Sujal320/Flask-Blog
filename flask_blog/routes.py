...
def post(post_id):
    post = Post.query.get_or_404(post_id) # give if the post with the given post_id exists or else throw a 404 error
...
If you did not make this request then simply ignore this email and no change will be reflected.        
'''
    mail.send(msg)
